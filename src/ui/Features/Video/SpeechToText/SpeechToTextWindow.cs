...
public class SpeechToTextWindow : Window
{
    ...
    private static (Control Label, Control Control)[] MakeGoogleCloudSttRows(SpeechToTextViewModel vm)
    {
        ...
        return new (Control, Control)[]
        {
            ...
            (MakeLabel(Se.Language.General.GoogleCloudSttBucketName), MakeText(nameof(vm.GoogleCloudSttBucketName), 300).BindIsVisible(vm, nameof(vm.IsGoogleCloudSttVisible))),
